...
<div class="ck-slide">
    <ul class="ck-slide-wrapper">
        <li>
            <a href="/toItemInfo/10000028.html"><img
...
<div id="study">
    ...
    <div class="study_left lf">
        <div id="product_parameters_main">
            <p><img src="${pageContext.request.contextPath}/images/index/wenan.png" alt=""/></p>
        ...
        <img id="study_product_main" src="${pageContext.request.contextPath}/images/index/index_hot_study_img1.png"
             alt=""/>
    </div>
...
<div id="gourmet">
    ...
    <div class="food_detail rt">
        <div>
            <div class="food1 lf">
                <img src="${pageContext.request.contextPath}/images/index/index_hot_food_img1.png" alt=""/>
            ...
            <div class="food1 lf">
                <img src="${pageContext.request.contextPath}/images/index/index_hot_food_img2.png" alt="" id="food1"/>
            ...
            <div class="food1 lf">
                <img src="${pageContext.request.contextPath}/images/index/index_hot_food_img3.png" alt=""/>
